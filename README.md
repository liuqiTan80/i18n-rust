...
- **VS Code 扩展**：从 [Releases](https://gitcode.com/tan80/zrRust/releases) 下载 `i18n-rust.vsix`，在 VS Code 中选择「从 VSIX 安装」即可（详见[安装说明](tools/vscode-extension/)）。提供语法高亮、智能补全、所有权可视化（颜色高亮变量移动与再使用）、一键运行/检查、AI 对话等完整 IDE 体验
