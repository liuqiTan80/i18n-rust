...
दो विकल्प हैं: **विकल्प 1 — crates.io से इंस्टॉल** (अनुशंसित); **विकल्प 2 — स्रोत से बिल्ड** (डेवलपर के लिए)।

**विकल्प 1: crates.io से इंस्टॉल (अनुशंसित)** — crates.io पर प्रकाशित; Rust टूलचेन हो तो एक कमांड ही काफी है:

```bash
cargo install rzc        # crates.io से प्राप्त कर स्थानीय रूप से बिल्ड (पहली बार 1–3 मिनट)
...
**विकल्प 2: स्रोत से बिल्ड (डेवलपर)** — पूरी चरण-दर-चरण प्रक्रिया नीचे है («1. Rust टूलचेन स्थापित करें» दोनों विकल्पों के लिए समान है)।
