...
> ⚠️ قد تكون هذه الترجمة قديمة. راجع [النسخة الصينية](README.md) أو [النسخة الإنجليزية](README.en.md) للاطلاع على أحدث المعلومات.
...
خياران: **الخيار 1 — التثبيت من crates.io** (موصى به)؛ **الخيار 2 — البناء من المصدر** (للمطورين).

**الخيار 1: التثبيت من crates.io (موصى به)** — منشور على crates.io؛ مع أدوات رست مثبتة تكفي أوامر قليلة:
...
**الخيار 2: البناء من المصدر (للمطورين)** — الخطوات الكاملة أدناه («1. تثبيت أدوات رست» مشترك بين الخيارين).
